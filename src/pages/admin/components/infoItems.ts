...
export const HOSTELERIA_INFO_ITEMS = [
  { icon: 'ri-inbox-line', text: 'Las solicitudes llegan del formulario "Hablemos de tu negocio" de /hosteleria.' },
  ...
  { icon: 'ri-lock-line', text: 'El cliente entra en /hosteleria con su código y PIN y ve solo su catálogo con sus precios — privado, nadie más lo ve.' },
];
